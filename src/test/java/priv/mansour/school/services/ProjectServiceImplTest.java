...
public class ProjectServiceImplTest {
	...
	public void setUp() {
		...
		teacher = new Teacher("John Doe", "Mavs", "john@doe.com", "password1");
		project1 = new Project("1", "2025", "MIAGE", "Project Description", "Project1", teacher,
				Arrays.asList(competence1, competence2));
		project2 = new Project("2", "2025", "MIAGE", "Another Description", "Project2", teacher,
				new ArrayList<>(Arrays.asList(competence1)));
	}
